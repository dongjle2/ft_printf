...
/*   Updated: 2024/03/06 15:18:55 by dongjle2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_sign(t_display *d, t_packet *k, int *ret_val);
...
static void	set_t_display(t_display *d, t_packet *k)
{
	...
	// if (d->num_space == 0 && k->space_flag && 0 <= k->val.i)
	// 	d->num_space ++;
	if (k->minus_flag == 1)
		d->space_location = 1;
}
